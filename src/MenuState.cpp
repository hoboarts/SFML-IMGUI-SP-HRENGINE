...
{
    m_menuSprite.setTexture(context.appInstance.getTexture("assets/images/green_menu.jpg"));
    m_menuSprite.setPosition(context.defaultView.getCenter());
    Utils::Position::centreOrigin(m_menuSprite);
    m_menuSprite.move(0.f, -40.f);

    m_cursorSprite.setTexture(context.appInstance.getTexture("assets/images/green_cursor.png"));

    auto& font = context.appInstance.getFont("assets/fonts/adinekir.ttf");

    m_texts.emplace_back("http://fallahn.itch.io/pseuthe", context.appInstance.getFont("assets/fonts/adinekir.ttf"), 96u);
    m_texts.back().setPosition(1200.f, 850.f);

    m_texts.emplace_back("press gtfo!", context.appInstance.getFont("assets/fonts/adinekir.ttf"), 96u);
    m_texts.back().setPosition(100.f, 850.f);
